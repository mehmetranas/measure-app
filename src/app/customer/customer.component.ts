  ...
  ngOnInit() {
   ...
   // fake data
    const customers = [
      ...
      {
        'customerDetailModel': {
          'nameSurname': 'Aykan Kuday PhD',
          'mobilePhone': '+90-507-216-63-67',
          'fixedPhone': '+90-749-461-29-52',
    ...
    //     .add(customer.customerDetailModel, customer.orderStatus)
    //     .subscribe((data) => console.log('Success', index));
    // });
  }
